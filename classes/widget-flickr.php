...
class Hybrid_Addons_Widget_Flickr extends WP_Widget {
	...
	function Hybrid_Addons_Widget_Flickr() {
		...
		$widget_options = array( 
			'classname' => 'flickr', 
			'description' => esc_html__('A simple widget to display your latest photos on Flickr.', 'hybrid-addons')
		);
		...
		/* Create the widget. */
		$this->WP_Widget( "{$this->prefix}-flickr", esc_attr__( 'Flickr', 'hybrid-addons' ), $widget_options, $control_options );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Flickr', 'hybrid-addons'), 'username' => __('40414712@N00', 'hybrid-addons'), 'photos' => '4', 'photo_size' => '75');
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'username' ); ?>"><?php _e('Flickr ID (find it using <a href="http://www.idgettr.com">idGettr</a>):', 'hybrid-addons'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'photos' ); ?>"><?php _e('Number of Photos:', 'hybrid-addons'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'photo_size' ); ?>"><?php _e('Photo Size:', 'hybrid-addons'); ?></label>
